...
namespace CustomJSONData.CustomBeatmap
{
    ...
    {
        public CustomObstacleData(float time, int lineIndex, ObstacleType obstacleType, float duration, int width, IDictionary<string, object> customData) : base(time, lineIndex, obstacleType, duration, width)
        {
